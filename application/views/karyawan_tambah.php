...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?php echo site_url('karyawan') ?>">Staff</a></li>
...
<section class="content">
	...
	<form class="form-horizontal" action="<?php echo site_url(). '/karyawan/tambah_aksi'; ?>" role="form" method="post">             
	<div class="form-group">
		<input type="hidden" class="form-control" name="idadmin" placeholder="idadmin" value=<?php echo $id; } ?>>
	...
	<div class="form-group">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-5">
			...
			<a href="<?php echo site_url('karyawan') ?>" class="btn btn-danger btn-block btn-flat">Cancel</a>
		</div>
	  </div> 
	</form>
</section><!-- /.content -->
